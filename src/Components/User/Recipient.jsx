      ...
      <div className="row text-center m-5">
        ...
        <Card >
          <Card.Body>
            ...
            <input type="text" placeholder='Full Name' className='form-control mb-2' onChange={e => setRecipientData({...recipientData, fullName: e.target.value})} />
            <input type="text" placeholder='Blood Type' className='form-control mb-2' onChange={e => setRecipientData({...recipientData, bloodType: e.target.value})}/>
            <input type="text" placeholder='Phone Number' className='form-control mb-2' onChange={e => setRecipientData({...recipientData, phoneNumber: e.target.value})}/>
            <Button variant="primary" onClick={handleAddRecipient}>Save</Button>
            <Toaster/>
          </Card.Body>
        </Card>
        </div>
